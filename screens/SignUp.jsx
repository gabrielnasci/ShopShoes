...
const SignUp = ({ navigation }) => {
  ...
  const registerUser = async (values) => {
    setLoader(true);
    try {
      const endpoint = 'http://10.5.4.241:3000/api/register';
      const data = { ...values, imageUrl: "https://uploaddeimagens.com.br/images/004/686/881/full/userDefault.png?1702146797" };
    ...
    <ScrollView>
      <SafeAreaView style={{ marginHorizontal: 20 }}>
        <View>
          ...
          <Text style={styles.title}>ShopShoes sua loja virtual</Text>
          <Formik
